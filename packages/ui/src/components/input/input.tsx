...
export interface NHInputProps extends Omit<HeroUIInputProps, 'color' | 'variant' | 'radius'> {
  /**
   * The input variant
   * @default "bordered"
   */
...
export const NHInput = forwardRef<HTMLInputElement, NHInputProps>(
  ({ 
    variant = 'bordered',
    color = 'default',
    radius = 'md',

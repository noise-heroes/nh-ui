    ...
    subtle: {
      light: (
        <>
          ...
          <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-orange-50/30 to-transparent" />
          <div className="absolute inset-0 bg-gradient-to-bl from-transparent via-teal-50/30 to-transparent" />
        </>
      ),
      dark: (
        <>
          <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-black to-gray-900" />
          <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-orange-950/20 to-transparent" />
          <div className="absolute inset-0 bg-gradient-to-bl from-transparent via-teal-950/20 to-transparent" />
        </>
      ),
    },
    vibrant: {

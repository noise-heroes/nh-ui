...
import { NHCard, NHCardBody, NHCardHeader, NHDivider, NHChip } from "@nh-ui/ui";
  ...
  return (
    <div className="min-h-screen p-8 max-w-7xl mx-auto">
      ...
      <NHCard className="mb-12">
        ...
        <NHCardBody className="space-y-6">
          {fontWeights.map((weight) => (
            <div key={weight.weight} className="flex items-baseline gap-4">
              <NHChip size="sm" variant="flat" className="min-w-[100px]">
      ...
      <NHCard className="mb-12">
        ...
        <NHCardBody className="space-y-8">
          {typeSizes.map((type) => (
            <div key={type.name}>
      ...
      <NHCard className="mb-12">
        ...
        <NHCardBody className="space-y-8">
          <div>
            <NHChip size="sm" variant="flat" className="mb-2">
      ...
      <NHCard>
        ...
        <NHCardBody className="prose max-w-none">

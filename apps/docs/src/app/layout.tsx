...
export const metadata: Metadata = {
  title: "Noise Heroes Human Interface Design Guidelines",
  description: "Comprehensive design system and component library for building Noise Heroes applications",
};
